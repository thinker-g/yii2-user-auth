...
class UserExtAccount extends \yii\db\ActiveRecord implements Oauth2Account
{
    ...
    /**
     * @inheritdoc
     * @see \thinker_g\UserAuth\interfaces\Oauth2Account::getOpenUid()
     */
    ...
    /**
     * @inheritdoc
     * @see \thinker_g\UserAuth\interfaces\Oauth2Account::setUserId()
     */
    ...
    /**
     * @inheritdoc
     * @see \thinker_g\UserAuth\interfaces\Oauth2Account::findByUserId()
     */
